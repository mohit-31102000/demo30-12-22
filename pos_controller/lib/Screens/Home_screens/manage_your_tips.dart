...
class ManageYourTips extends StatefulWidget {
  const ManageYourTips({Key? key}) : super(key: key);

  @override
  State<ManageYourTips> createState() => _ManageYourTipsState();
}

class _ManageYourTipsState extends State<ManageYourTips> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: DataTable(
              dataRowColor:
                  MaterialStateColor.resolveWith((states) => Color(0xff141414)),
